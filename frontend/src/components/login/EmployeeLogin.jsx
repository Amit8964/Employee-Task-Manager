...
<div className="login-input-container">
    <input type="email" name="employee_id" placeholder="Employee Id" onChange={handleInput} />
...
<p><span style={{color:"gray"}}></span> <Link to={"/"} style={{color:"#fff"}}> forgot password</Link> </p>
